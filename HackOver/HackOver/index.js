...
var firebaseConfig = {
  ...
  function login () {
    ...
    .then(function() {
      ...
      if(organiser == 'no' || organiser == 'No' || organiser == 'N'|| organiser == 'n' )
      {
        window.location.replace("indexhome.html");
      }
      else if(organiser == 'yes' || organiser== 'Yes' || organiser == 'Y'|| organiser == 'y' )
      {
        window.location.replace("organizerside.html");
      }
      else
      {
